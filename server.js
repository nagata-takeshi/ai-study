...
//                });
              ...
              var options = {
                  ...
                  method: 'POST',
                  headers: {'Content-Type': 'application/json', 'Authorization': 'Bearer rfpRykhDtQ9hmPFvidOHlXPW9Me61diB+VzXFy1Q9kU5JJv86qZB3sMoz3E35M0PCK4KB0CEzBJfPmNtYhWSFw==', 'Content-Length': 347 },
              ...
              request(options, function(error, response, body) {
                  session.send("statusCode:" + response.statusCode);
              })
